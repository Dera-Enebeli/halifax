  ...
  "@graph": [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Consultation", item: `${baseUrl}/consultation` },
        { "@type": "ListItem", position: 4, name: "Oakland Real Estate", item: `${baseUrl}/areas/oakland` },
        { "@type": "ListItem", position: 5, name: "Berkeley Real Estate", item: `${baseUrl}/areas/berkeley` },
        { "@type": "ListItem", position: 6, name: "Walnut Creek Real Estate", item: `${baseUrl}/areas/walnut-creek` },
        { "@type": "ListItem", position: 7, name: "Dublin Real Estate", item: `${baseUrl}/areas/dublin` },
        { "@type": "ListItem", position: 8, name: "Pleasanton Real Estate", item: `${baseUrl}/areas/pleasanton` },
      ],
    },
    {
      "@type": "Review",
