...
import { Home, Building2, DollarSign, Phone, Mail, MapPin, ArrowRight } from "lucide-react"
...
const offices = [
  ...
  },
  {
    label: "Second Office",
    city: "Antioch",
    address: agent.secondaryAddress,
  },
]
          ...
          <div className="max-w-page section-padding">
            <div className="max-w-3xl mx-auto text-center mb-14">
              <ScrollReveal>
                ...
                <p className="text-body text-near-black/75 leading-relaxed font-light max-w-xl mx-auto">
            ...
            <ScrollReveal>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8 py-8 md:py-10 text-center border-y border-warm-border mb-14">
                {stats.map((stat) => (
                  <div key={stat.label}>
                    <p className="font-serif italic text-[clamp(26px,3.5vw,38px)] text-near-black leading-tight">
                      {stat.value}
                    </p>
                    <p className="text-xs tracking-[1.5px] uppercase text-near-black/75 mt-1">
                      {stat.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="max-w-3xl mx-auto text-body text-near-black/80 space-y-5 leading-relaxed">
              <ScrollReveal>
                <p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {services.map((item, i) => {
                ...
                return (
                  ...
                  <div className="relative overflow-hidden bg-cream pt-0 px-7 pb-7 rounded-lg shadow-lg shadow-black/10">
                    ...
                    <div className="relative z-[1]">
                      ...
                      <Link
                        href={item.href}
                        className="inline-flex items-center gap-1.5 text-sm font-semibold text-crimson hover:text-crimson-dark transition-colors mt-4"
                      >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12 md:mb-14">
                <ScrollReveal>
                  ...
                  <h2 className="font-serif italic text-[clamp(28px,4vw,42px)] text-near-black leading-[1.15] mb-4">
                    Two Offices, One <span className="text-crimson">Mission</span>
                  </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {offices.map((office, i) => (
                  <ScrollReveal key={office.city} delay={i * 150}>
                  <div className="bg-cream p-6 md:p-8 rounded-lg border border-warm-border">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <p className="text-xs font-bold tracking-wider uppercase text-crimson mb-0.5">{office.label}</p>
                        <h3 className="font-serif italic text-xl text-near-black leading-tight">{office.city}</h3>
                      </div>
                    </div>
                    <p className="text-sm text-near-black/85 leading-relaxed mb-5">{office.address}</p>
                    <div className="flex flex-col gap-2.5">
                      <a href="tel:+15105075088" className="flex items-center gap-2.5 text-sm text-near-black/75 hover:text-crimson transition-colors duration-200">
                        <Phone className="h-3.5 w-3.5 text-crimson shrink-0" />
                        {agent.phone}
                      </a>
                      <a href="mailto:Enebly@aol.com" className="flex items-center gap-2.5 text-sm text-near-black/75 hover:text-crimson transition-colors duration-200">
          ...
          <div className="max-w-page section-padding">
            <div className="max-w-3xl mx-auto text-center">
              <ScrollReveal>
                ...
                <h2 className="font-serif italic text-[clamp(28px,4vw,42px)] text-near-black leading-[1.15] mb-4">
                  One Company, Two <span className="text-crimson">Expert Teams</span>
                </h2>
                <div className="w-12 h-[3px] bg-crimson mx-auto mb-6" />
                <p className="text-body text-near-black/75 leading-relaxed font-light max-w-2xl mx-auto mb-8">
                ...
                <Link
                  href="/team"
                  className="inline-flex items-center justify-center gap-2 border-2 border-crimson text-crimson text-sm font-semibold px-7 py-3.5 rounded-full hover:bg-crimson hover:text-white transition-all duration-200"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {certifications.map((cert, i) => (
                  ...
                  <div className="relative overflow-hidden bg-cream pt-0 px-5 pb-6 text-center rounded-lg shadow-lg shadow-black/10">
                    ...
                    <p className="text-xs text-near-black/70 leading-snug break-words">{cert.name}</p>
                  </div>
                  </ScrollReveal>
                ))}
              </div>
        ...
        <section className="py-20 md:py-24 bg-cream-dark">
          <div className="max-w-page section-padding">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="w-12 h-[3px] bg-crimson mx-auto mb-6" />
              <p className="text-sm text-near-black/75 font-light mb-10 sm:mb-10 md:mb-12 lg:mb-14 max-w-md mx-auto">
